    ...
    return (
      <main className="my-8 grid justify-items-center">
        <div className="relative grid w-max justify-items-center">
          <h1 className="z-10 mb-6 w-[16.5rem] bg-[--background-color] px-2 text-center text-xl font-semibold sm:mb-8 sm:w-[20.5rem] sm:px-4 sm:text-2xl md:w-[24.5rem] md:text-3xl xl:w-max">
            {prebuilt.name}
          </h1>
